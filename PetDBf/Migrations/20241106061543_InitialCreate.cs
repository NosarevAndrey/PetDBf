    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptedPets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdoptedPets_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdoptedPets_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptedPets_ClientId",
                table: "AdoptedPets",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptedPets_PetId",
                table: "AdoptedPets",
                column: "PetId",
                unique: true);
